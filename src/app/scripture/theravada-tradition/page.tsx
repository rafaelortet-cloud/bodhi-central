                    ...
                    <section>
                        <div className="mx-auto max-w-container px-4 pb-20 md:px-6 grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                            <div className="flex flex-col items-center justify-center gap-0">
                                <Image src="/vinaya-pitaka-card-thumbnail-img-02.jpg" alt="Gelug" width={240} height={240} className="rounded-t-[4.5rem]" />
                                <div className="flex flex-col items-center justify-center bg-white/65 dark:bg-black/40 p-3 border-t-2 border-brand-200 rounded-t-[3rem] rounded-b-[1rem]">
                                    <h2 className="text-display-sm text-primary text-center py-2">Vinaya Pitaka</h2>
                            ...
                            <div className="flex flex-col items-center justify-center gap-0">
                                <Image src="/vinaya-pitaka-card-thumbnail-img-02.jpg" alt="Sakya" width={240} height={240} className="rounded-t-[4.5rem]" />
                                <div className="flex flex-col items-center justify-center bg-white/65 dark:bg-black/40  p-3 border-t-2 border-brand-200 rounded-t-[3rem] rounded-b-[1rem]">
                                    <h2 className="text-display-sm text-primary text-center py-2">Sutta Pitaka</h2>
                            ...
                            <div className="flex flex-col items-center justify-center gap-0">
                                <Image src="/vinaya-pitaka-card-thumbnail-img-02.jpg" alt="Sakya" width={240} height={240} className="rounded-t-[4.5rem]" />
                                <div className="flex flex-col items-center justify-center bg-white/65 dark:bg-black/40 p-3 border-t-2 border-brand-200 rounded-t-[3rem] rounded-b-[1rem]">
                                    <h2 className="text-display-sm text-primary text-center py-2">Abhidhamma Pitaka</h2>

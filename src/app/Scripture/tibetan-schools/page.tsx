    ...
    return (
        <>
            <div className="relative mx-auto bg-[url(/himalayan-scenery-02.jpg)] bg-cover bg-center bg-no-repeat">
                ...
                <div className="absolute inset-0 bg-white/80 dark:bg-black/62 z-0" aria-hidden="true" />
                    ...
                    <section>
                        <div className="mx-auto max-w-container px-4 pb-20 md:px-6 grid grid-cols-2 md:grid-cols-4 gap-8 items-start">
                            <div className="flex flex-col items-center justify-center gap-4">
                                ...
                                <div className="flex flex-col items-center justify-center bg-white/65 dark:bg-black/40 p-2 border-b-2 border-yellow-800/40 rounded-t-4xl rounded-b-4xl">
                            ...
                            <div className="col-start-2 md:col-start-4 flex flex-col items-center justify-center gap-4">
                                ...
                                <div className="flex flex-col items-center justify-center bg-white/65 dark:bg-black/40  p-2 border-b-2 border-green-800/40 rounded-t-4xl rounded-b-4xl">
                            ...
                            <div className="col-start-1 md:col-start-2 h-auto md:-mt-40 flex flex-col items-center justify-center gap-4">
                                ...
                                <div className="flex flex-col items-center justify-center bg-white/65 dark:bg-black/40 p-2 border-b-2 border-cyan-800/40 rounded-t-4xl rounded-b-4xl">
                            ...
                            <div className="col-start-2 md:col-start-3 h-auto md:-mt-40 flex flex-col items-center justify-center gap-4">
                                ...
                                <div className="flex flex-col items-center justify-center bg-white/65 dark:bg-black/40 p-2 border-b-2 border-pink-800/40 rounded-t-4xl rounded-b-4xl">

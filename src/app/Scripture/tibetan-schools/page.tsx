                ...
                <div className="relative z-10">
                    ...
                    <section>
                        <div className="mx-auto max-w-container px-4 pb-20 md:px-6 grid grid-cols-4 gap-8 items-start">
                            ...
                            <div className="col-start-2 h-auto -mt-40 flex flex-col items-center justify-center p-4 bg-white/65 dark:bg-black/40 rounded-t-full shadow-lg border-b-4 border-blue-800/40">
                                ...
                                <p className="pb-2 text-md text-tertiary text-center">In the Nyingma tradition, thirteen classics of Indian Mahayana philosophy are taught at Tibetan centers of education throughout Asia and the West.</p>
                            </div>
                            <div className="col-start-3 h-auto -mt-40 flex flex-col items-center justify-center p-4 bg-white/65 dark:bg-black/40 rounded-t-full shadow-lg border-b-4 border-red-800/40">
                                ...
                                <p className="pb-2 text-md text-tertiary text-center">The Eight Kagyu commentaries were recommended by the 16th Karmapa, Rangjung Rigpe Dorje, as the basis for study in the shedra at Rumtek Monastery.</p>
                            </div>
                        </div>
                    </section>
                </div>

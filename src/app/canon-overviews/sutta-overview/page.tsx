        ...
        <div className="bg-primary">
            <div className="relative mx-auto flex max-w-container flex-col items-center px-4 py-16 md:flex-row md:px-8 md:pt-16 md:pb-24">
                <div className="flex max-w-180 flex-col items-start md:absolute">
                    ...
                    <h1 className="mt-4 text-display-md font-semibold text-primary md:text-display-xl">The Basket of Discourses: the Buddha's teachings</h1>
                    <p className="mt-4 max-w-140 text-lg text-tertiary md:mt-6 md:text-xl">
                        The Sutta Piṭaka, the “Basket of Discourses”, contains the Buddha’s teachings, as well as stories and accounts of his life and ministry.
                    </p>

                    ...
                    <section>
                        <div className="mx-auto max-w-4xl px-4 pb-20 md:px-6 grid grid-cols-2 md:grid-cols-2 gap-16 items-start">
                            <div className="flex flex-col items-center justify-center gap-0">
                                <div className="flex flex-col items-center justify-center bg-linear-to-b from-white/0 via-white/35 via-55% to-white/0 dark:bg-linear-to-b dark:from-black/10 dark:via-black/70 dark:via-55% dark:to-black/10 p-4 rounded-[7rem]">

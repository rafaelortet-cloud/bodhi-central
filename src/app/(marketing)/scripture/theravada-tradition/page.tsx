...
export default function TheravadaTraditionPage() {
    ...
    return (
        <div>
            {/* Hero Section */}
            <section className="relative flex flex-col items-center justify-center gap-4 mx-auto h-screen bg-[url(/jetavanaramaya-scene-01.jpg)] bg-cover bg-center bg-no-repeat">

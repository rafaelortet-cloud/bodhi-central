    ...
    return (
        <>
            <div className="relative mx-auto bg-[url(/jetavanaramaya-scene-01.jpg)] bg-cover bg-center bg-no-repeat pb-36">
                ...
                <div className="absolute inset-0 bg-white/50 dark:bg-black/40 z-0" aria-hidden="true" />

                {/* Content layer */}
                <div className="relative z-10">
                    <section className="flex flex-col items-center justify-center pt-20 pb-12 px-4 md:px-6">
                        <h1 className="text-display-md text-brand-900 dark:text-brand-200 md:text-display-lg lg:text-display-xl">Theravāda Tradition</h1>

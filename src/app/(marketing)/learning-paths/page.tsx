            ...
            <section className="relative flex flex-col items-center justify-center gap-4 mx-auto h-screen bg-[url(/tibetan-buddhist-library-01.jpg)] bg-cover bg-center bg-no-repeat">
                ...
                <div className="relative flex flex-col items-center justify-center gap-12 z-10">
                    ...
                    <div className="md:flex flex-col items-center justify-center gap-1 px-4 md:px-6 animate-[fadeUp_1s_ease_both] delay-300 ">
                        <h1 className="text-display-sm font-extralight text-center text-brand-300 dark:text-brand-300 md:text-display-lg lg:text-display-3xl text-shadow-brand-950 text-shadow-sm">Learning Paths Overview</h1>

...
export default function DigitalPortalsPage() {
    return (
        <>
            {/* Hero Section */}
            <section className="relative flex flex-col items-center justify-center gap-4 mx-auto h-screen bg-[url(/buddhist-study-centers-planetary-upscaled-1600px-80.webp)] bg-cover bg-center bg-no-repeat">

        ...
        <section className="py-10 md:py-14 bg-linear-to-b from-red-50 to-orange-100 dark:bg-linear-to-b dark:from-gray-900 dark:to-red-950">
            ...
            <div className="mt-4 transition-all duration-300">
                {!isRowsLayout ? (
                    ...
                    <div className="mx-auto max-w-5xl px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-start animate-in fade-in duration-500">
                        {/* The Kangyur */}
                        <div className="flex flex-col items-center justify-start bg-secondary p-2 rounded-4xl drop-shadow-sm h-full max-w-lg mx-auto w-full">
                            ...
                            <div className="mx-auto w-full grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-2 rounded-3xl p-2">
                                ...
                                <div className="mx-auto w-full col-span-2 flex flex-col items-center justify-center gap-0 bg-yellow-100/60 dark:bg-yellow-800/40 px-2 py-2 rounded-2xl border border-yellow-300 dark:border-yellow-700">
                        ...
                        {/* The Tengyur */}
                        <div className="flex flex-col items-center justify-start bg-secondary p-2 rounded-4xl drop-shadow-md h-full max-w-lg mx-auto w-full">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-2 rounded-3xl p-2">
                                ...
                                <div className="mx-auto w-full flex flex-col items-center justify-center gap-0 bg-orange-100/60 dark:bg-orange-700/40 px-2 py-2 rounded-2xl border border-orange-200 dark:border-orange-700">
                                ...
                                <div className="mx-auto w-full flex flex-col items-center justify-center gap-0 bg-blue-100/60 dark:bg-blue-800/40 px-2 py-2 rounded-2xl border border-blue-200 dark:border-blue-700">
                    ...
                    <div className="mx-auto max-w-container px-4 md:px-6 grid grid-cols-1 gap-4 items-start animate-in fade-in duration-500">
                        ...
                        <div className="flex flex-col bg-secondary p-6 gap-2 rounded-4xl drop-shadow-sm">
                            ...
                            <div className="mx-auto w-full grid grid-cols-1 md:grid-cols-4 gap-2 items-start justify-center rounded-3xl mt-2">
                                <div className="mx-auto w-full flex flex-col items-center justify-center gap-0 bg-blue-100/60 dark:bg-blue-900/40 px-10 py-3 rounded-2xl border border-blue-200 dark:border-blue-700">
                                    <p className="text-lg font-light text-primary/70 text-center tracking-tight">འདུལ་བ།</p>
                                    <p className="text-md font-bold text-center text-secondary">Disciplinary Rules</p>
                                </div>
                                <div className="mx-auto w-full flex flex-col items-center justify-center gap-0 bg-yellow-100/60 dark:bg-yellow-900/40 px-10 py-3 rounded-2xl border border-yellow-300 dark:border-yellow-800">
                                    <p className="text-lg font-light text-primary/70 text-center tracking-tight">ཤེར་ཕྱིན།</p>
                                    <p className="text-md font-bold text-center text-secondary">Perfection of Wisdom</p>
                                </div>

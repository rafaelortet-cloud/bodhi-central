...
export const SidebarNavigationSectionsSubheadings = ({ activeUrl = "/", items, user }: SidebarNavigationSectionsSubheadingsProps) => {
    ...
    const content = (
        <aside
            ...
            className="flex h-full w-full max-w-full flex-col justify-between overflow-auto border-secondary bg-primary pt-4 shadow-xs md:border-r lg:w-(--width) lg:rounded-2xl lg:border lg:pt-5 drop-shadow-xl dark:drop-shadow-gray-900"
        >
            <div className="flex flex-col gap-5 px-4 lg:px-5 pb-4">
                <Link href="/" className="focus:outline-hidden">
                    <BodhicentralLogo className="h-10" />
                </Link>
            </div>
    ...
    return (
        <>
            ...
            <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:py-4 lg:pl-4">{content}</div>

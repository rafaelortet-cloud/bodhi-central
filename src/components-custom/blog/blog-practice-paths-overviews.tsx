...
const articles: Article[] = [
    {
        id: "article-1",
        title: "The Theravada Practice systems",
        summary: "Lorem ipsum...",
        href: "#",
        category: {
            name: "Theravāda practice",
            href: "#",
        },
    ...
    {
        id: "article-2",
        title: "The Mahayana Practice Systems",
        summary: "Lorem ipsum...",
        href: "#",
        category: {
            name: "Mahayana practice",
            href: "#",
        },
    ...
    {
        id: "article-3",
        title: "The Vajrayana Practice Systems",
        summary: "Lorem ipsum...",
        href: "#",
        category: {
            name: "Vajrayana practice",
            href: "#",
        },
...
export const BlogSectionPracticePathsOverviews = () => {
    return (
            ...
            <div className="mx-auto max-w-container px-4 md:px-8">
                <div className="flex flex-col items-start justify-between lg:flex-row">
                    <div className="max-w-3xl">
                        <span className="text-sm font-light text-brand-600 dark:text-brand-700 md:text-md">Practice Paths</span>
                        <h2 className="mt-2 text-display-sm font-extralight text-brand-800 dark:text-brand-300 md:text-display-lg">Practice Systems across Traditions</h2>
                        <p className="mt-4 text-lg text-tertiary md:mt-2 md:text-xl">Main streams of practice in the Theravāda, Mahayana, and Vajrayana traditions.</p>
                    </div>
